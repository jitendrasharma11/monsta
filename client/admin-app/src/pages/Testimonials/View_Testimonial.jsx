        ...
        <table className='w-full text-gray-500'>
            <thead className='text-gray-900 text-[12px] uppercase bg-gray-50'>
                <tr>
                    ...
                    <th scope='col' className='w-[15%]'>Designation</th>
                    <th scope='col' className='w-[12%]'>Rating</th>
            ...
            <tbody>
                ...
                <tr className='bg-white hover:bg-gray-50'>
                    ...
                    <th className='px-2 py-4'>
                        ...
                        <div className=' cursor-pointer w-[40px]  flex items-center justify-center h-[40px] rounded-[50%] bg-blue-700 hover:bg-blue-800'>
                        <Link to={'/user'}>
                        <FaPen className='text-white ' />
                        </Link>
                        </div>
